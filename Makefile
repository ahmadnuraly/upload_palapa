...
# UploadPalapa
#
# Plugin untuk mengunggah data ke geoportal Palapa
#							 -------------------
#		begin				: 2022-01-27
#		git sha				: $Format:%H$
#		copyright			: (C) 2022 by BIG
...
SOURCES = \
	__init__.py \
	upload_palapa.py upload_palapa_dialog.py

PLUGINNAME = upload_palapa

PY_FILES = \
	__init__.py \
	upload_palapa.py upload_palapa_dialog.py

UI_FILES = upload_palapa_dialog_base.ui
